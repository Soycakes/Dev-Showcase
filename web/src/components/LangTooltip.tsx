...
// Rendered inside LangSwitcher's relative container — positioned relative to the button, not the screen.
export function LangTooltip({ onDismiss }: Props) {
  return (
    <div
      ...
      onClick={onDismiss}
    >
      {/* Arrow points up toward the lang switcher button, right-aligned */}
