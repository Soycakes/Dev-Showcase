...
export const projects: Project[] = [
  ...
  },
  {
    ...
    status: 'shipped',
    media: [{ kind: 'image', src: '/Dev-Showcase/media/SLG_Graph.png', alt: 'SoyLangGraph agent graph', thumbFit: 'contain' }],
    snippets: [],
    repoUrl: 'https://github.com/Soycakes/SoyLangGraph',
  },
  {
    id: 'factory-game',
    title: { en: 'Untitled Factory Game', ko: 'Untitled Factory Game' },
    role: { en: 'Game Systems Engineer', ko: '게임 시스템 개발자' },
    subtitle: { en: '2D Multiplayer Factory Game', ko: '2D 멀티플레이어 팩토리 게임' },
    period: 'Jun 2026 - Present',
    categories: ['game-dev', 'systems'],
    stack: ['Unity', 'C#', 'ECS / DOTS', 'Netcode for Entities', 'Burst Compiler'],
    status: 'wip',
    media: [],
    snippets: [],
    snippetsDir: 'unity-dots-multiplayer-factory-game',
  },
  {
    id: 'blobday',
  ...
  },
  {
    ...
    snippetsDir: 'unity-puzzle-slimecake',
  },
  {
    id: 'boss-fights',
    ...
    snippetsDir: 'unity-2d-boss-fight-game',
  },
  {
    id: 'mmo-emulator',
  ...
  },
  {
    ...
    snippetsDir: 'react-terraria-data-picker',
  },
  {
    id: 'dodgeball',
    ...
    status: 'archived',
    media: [{ kind: 'image', src: '/Dev-Showcase/media/Dodgeball_1.png', alt: 'Dodgeball gameplay screenshot' }],
    snippets: [],
    videoUrl: '/Dev-Showcase/media/DodgeballGameplay.mp4',
  },
  {
    id: 'android-drawing',
  ...
  },
  {
    ...
    stack: ['ASP.NET Core MVC', 'C#', 'MySQL'],
    status: 'archived',
    media: [],
    snippets: [],
  },
